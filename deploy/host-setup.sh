...
echo "  - write /etc/nginx/analytics-exclude.conf, from the .example beside"
echo "    deploy/nginx/ - optional, but wanted BEFORE ghul.dev points at the"
echo "    analytics, because there is no way to remove one visitor afterwards"
